...
import { Activity, Terminal, Play, Settings, ChevronDown, FolderOpen } from 'lucide-react';
  ...
  return (
    <div className="h-12 border-b border-primary/20 bg-card flex items-center justify-between px-4 select-none shrink-0 relative z-20">
      <div className="flex items-center gap-6">
        ...
        >
          <img src={`${import.meta.env.BASE_URL}images/logo.png`} alt="Logo" className="w-6 h-6 group-hover:animate-pulse-neon" />
